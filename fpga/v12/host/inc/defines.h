...
{
#if defined(__OPENCL__)
    return rho * w[i] * (1.0 + 3.0 * dotVecIndex_Real(e[i], u) + 9.0 / 2.0 * dotVecIndex_Real(e[i], u) * dotVecIndex_Real(e[i], u) - 3.0 / 2.0 * dotVecReal(u, u));
#else
    return rho * w[i] * (1.0 + 3.0 * dotVec(e[i], u) + 9.0 / 2.0 * dotVec(e[i], u) * dotVec(e[i], u) - 3.0 / 2.0 * dotVec(u, u));
#endif
}
